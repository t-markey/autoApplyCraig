# taken from the main page. This is only US regions

s = '''https: // auburn.craigslist.org/
...
# cuts out the unnecessary info to make a list of option menu
new = s.replace('https: // ', '')
newer = new.replace('.craigslist.org/', '')
regionalUsList = newer.splitlines()
